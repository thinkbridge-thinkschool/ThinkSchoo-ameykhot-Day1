...
public static class EndpointExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var expiresInSeconds = configuration.GetValue<int?>("Jwt:AccessTokenLifetimeSeconds") ?? 900;
        var accessToken = GenerateJwtToken(user, configuration, TimeSpan.FromSeconds(expiresInSeconds));
    ...
    private static string GenerateJwtToken(User user, IConfiguration configuration, TimeSpan lifetime)
    {
