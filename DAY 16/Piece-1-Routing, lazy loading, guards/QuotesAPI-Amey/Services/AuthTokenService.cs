...
public class AuthTokenService : IAuthTokenService
{
    ...
    public async Task<TokenPair> IssueTokenPairAsync(User user, Guid? familyId = null, CancellationToken cancellationToken = default)
    {
        ...
        var accessLifetime = _jwtOptions.Value.AccessTokenLifetime;
        ...
        activity?.SetTag("token.lifetime_seconds", (int)accessLifetime.TotalSeconds);
        return new TokenPair(accessToken, refreshToken.RawToken, (int)accessLifetime.TotalSeconds);
    }
    ...
    public async Task<RefreshOutcome> RefreshAsync(string refreshToken, CancellationToken cancellationToken = default)
    {
        ...
        var accessLifetime = _jwtOptions.Value.AccessTokenLifetime;
        var accessToken = GenerateJwtToken(existing.User, accessLifetime);
        ...
        return new RefreshOutcome(
            new TokenPair(accessToken, nextRefresh.RawToken, (int)accessLifetime.TotalSeconds),
